...
function Album(props) {
    ...
    return (
        <div className="w-[200] h-[200] rounded-lg overflow-hidden relative text-white
        ...
        group-hover:bg-[#42cbcf] flex-shrink-0"
                ...
                <div>
                    ...
                    <h4 className=" text-[15px] uppercase rounded-full font-extrabold ">{album.artists[0].name}</h4>
                </div>
            </div>
        </div>
    );
